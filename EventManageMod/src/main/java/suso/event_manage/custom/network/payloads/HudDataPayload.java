...
import suso.event_manage.custom.network.packets.HudDataPacket;
...
public class HudDataPayload extends HudDataPacket implements CustomPayload {
    ...
    public HudDataPayload(DataTypes type, PacketByteBuf buf) {
        super(type, buf);
    }
    ...
    public static HudDataPayload ofState(EvtBaseConstants.States state) {
        ...
        return new HudDataPayload(DataTypes.STATE, buf);
    }
    ...
    public static HudDataPayload ofTimer(long time) {
        ...
        return new HudDataPayload(DataTypes.TIMER, buf);
    }
    ...
    public static HudDataPayload ofFeed(UUID player1, Identifier texture, @Nullable UUID player2) {
        ...
        return new HudDataPayload(DataTypes.FEED, buf);
    }
    ...
    public static HudDataPayload ofAgility(boolean active) {
        ...
        return new HudDataPayload(DataTypes.AGILITY, buf);
    }

    public static HudDataPayload ofPrimaticaScore(PrimaticaScore score) {
        PacketByteBuf buf = PacketByteBufs.create();
        ...
        return new HudDataPayload(DataTypes.PRIMATICA_SCORE, buf);
    }
    ...
    public static HudDataPayload ofInfo(Identifier id) {
        ...
        return new HudDataPayload(DataTypes.INFO, buf);
    }
    ...
    public static HudDataPayload ofKill(ServerPlayerEntity victim) {
        ...
        return new HudDataPayload(DataTypes.KILL, buf);
    }
}
