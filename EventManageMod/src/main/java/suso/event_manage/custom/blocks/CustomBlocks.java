...
public class CustomBlocks {
    ...
    public static BlockEntityType<GunkBlockEntity> GUNK_BLOCK_ENTITY;
    ...
    public static void register() {
        ...
        PINK_GUNK = register("suso:pink_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.PINK).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        PURPLE_GUNK = register("suso:purple_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.PURPLE).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        BLUE_GUNK = register("suso:blue_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.BLUE).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        CYAN_GUNK = register("suso:cyan_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.CYAN).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        LIGHT_BLUE_GUNK = register("suso:light_blue_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.LIGHT_BLUE).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        GREEN_GUNK = register("suso:green_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.GREEN).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        LIME_GUNK = register("suso:lime_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.LIME).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
        YELLOW_GUNK = register("suso:yellow_gunk", new GunkBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.YELLOW).slipperiness(0.99F).sounds(BlockSoundGroup.SLIME)));
